...
<!-- TemplateEndEditable -->
<!-- TemplateParam name="id" type="text" value="sidebar" -->
<style type="text/css">
a:link {
...
<div id="header">
      ...
      <div id="DivUserWelcome"><?php $urlLogout="<a href='/doLogout.php' style='color:#F6F6F6'> [Logout] </a>";
if (isset($_SESSION['MM_Username'])){echo "Welcome  ".$_SESSION['MM_Username']."  ".$urlLogout;
        
         echo  "<br /><a href='/myAccount.php' style='color:#F6F6F6'> My Account </a>";}?>
      </div>
    <!--navbar ending div. -->
      <div id="searchbar">
  ...
  <div id="main"><!-- TemplateBeginEditable name="EditRegionSidebar" -->
    <div id="sidebar">
      <div class="panel">
  ...
  <!-- TemplateEndEditable --><!--sidebar ending div. --><!-- TemplateBeginEditable name="EditRegionContent" -->
  <div id="content">
    <div class="panel">
      <div class="panelBody">
        <p>&nbsp;</p>
  ...
  <!-- TemplateEndEditable --><!--content ending div. -->
  </div><!--main ending div. -->
