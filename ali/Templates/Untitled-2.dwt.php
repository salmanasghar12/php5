...
<div class="container">
  <div class="header"><a href="#"><img src="../images/Logo SEO Exchange.png" alt="Insert Logo Here" name="Insert_logo" width="268" height="58" hspace="20" vspace="45" id="Insert_logo" style="/* [disabled]background: #8090AB; */ display:block;" /></a> 
    <!-- end .header --></div>
  <div class="sidebar1">
    <ul class="nav">
  ...
  <div class="content">
    ...
    <!-- end .content --></div>
  <div class="footer">
    <p>This .footer contains the declaration position:relative; to give Internet Explorer 6 hasLayout for the .footer and cause it to clear correctly. If you're not required to support IE6, you may remove it.    <!-- end .footer --></p>
  </div>
  <!-- end .container --></div>
</body>
</html>
