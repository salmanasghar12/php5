...
if (isset($_SESSION['MM_Username'])){echo "Welcome  ".$_SESSION['MM_Username']."  ".$urlLogout;
  ...
  <div id="main">
    ...
    <div id="content">
      <div class="panel">
        <div class="panelBody">
          <h1>Rules for Link Submission: </h1>
          <p><strong>Your site will removed from link directory without a prior notification if it violates the rules given below:</strong></p>
          <p>&nbsp;</p>
          <h2> Do not submit sites:</h2>
          <ol>
            <li><strong> Containing gambling, casino, other activity with an entry fee and a prize or links to other sites that contain it.</strong></li>
            <li><strong> Containing obviously explicit images, galleries or adult content. </strong></li>
            <li><strong> Containing  materials violating the copyright, trademark, right of publicity or privacy.</strong></li>
            <li><strong> Support pyramid or ponzi schemes, matrix programs, other &quot;get rich quick&quot; schemes.</strong></li>
            <li><strong> Containing the propaganda of violence, hatred, fraud, promote, facilitate or instruct others to engage in illegal activity.</strong></li>
            <li><strong> Containing pirate software or links to other sites that contain it.</strong></li>
            <li><strong>Selling or advertising weapons, ammunition, and other illegal products and activities.</strong></li>
            <li><strong>Selling or advertising prescription drugs, narcotics, steroids, certain controlled substances or other products that present a risk to consumer safety.</strong></li>
            <li><strong> With popup windows that interfere with viewing the main content of the site. </strong></li>
            <li><strong> Created only for Search Engines.</strong></li>
            <li><strong> Mirror sites that have the same content, but different URLs. </strong></li>
            <li><strong>Are under construction.</strong></li>
            <li><strong> Make sure that all images and links on your site work properly.</strong></li>
            <li><strong> Do not submit sites that redirect visitors to another site.</strong></li>
          </ol>
        </div>
        <!--panelBody ending div--> 
      </div>
