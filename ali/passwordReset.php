...
//////////////////////////////////   updating Password   //////////////////////////////////////
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "formPasswordReset")) {
  ...
  $Result1 = mysql_query($updateSQL, $seoExchangeDbConnection) or die(mysql_error());

  $updateGoTo = "passwordReset.php?update=1";
  if (isset($_SERVER['QUERY_STRING'])) {
    ...
    <div id="content">
      <div class="panel">
        <div class="panelBody">
          ...
          <p>Please Enter Your Password Details Below.</p>
          <p style="color:#F00">
            <?php if (isset($_GET['update'])){echo "Your New Password has been reset.";}?>
          </p>
          <form id="formPasswordReset" name="formPasswordReset" method="POST" action="<?php echo $editFormAction; ?>">
            <table width="720">
              <tr>
                <td width="156"><h4>New Password:</h4></td>
                <td width="552"><span id="sprytextfieldNewPass">
              ...
              <tr>
                ...
                <td><span id="spryconfirmNewPass">
                  <input name="newPass2" type="password" id="newPass2" size="30" maxlength="30" />
                  <span class="confirmRequiredMsg">A value is required.</span><span class="confirmInvalidMsg">Password Not  matched with New Password..</span></span></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><input name="changePass" type="submit" class="Button" id="changePass" value="Reset" /></td>
              </tr>
            </table>
            <input type="hidden" name="MM_update" value="formPasswordReset" />
          </form>
          <p>&nbsp;</p>
        </div>
        <!--panelBody ending div--> 
...
var sprytextfield2 = new Spry.Widget.ValidationTextField("sprytextfieldNewPass");
var spryconfirm1 = new Spry.Widget.ValidationConfirm("spryconfirmNewPass", "newPass");
  </script> 
    <!--content ending div. --> 
  </div>
  <!--main ending div. -->
