...
<div id="container" style="height:1600px">
  <div id="header">
...
if (isset($_SESSION['MM_Username'])){echo "Welcome  ".$_SESSION['MM_Username']."  ".$urlLogout;
  ...
  <div id="main">
    ...
    <!--sidebar ending div. -->
    <div id="content" style="height:1301px">
      <div class="panel">
        <div class="panelBody">
          <h1>Tips &amp; Tricks</a> for Link Submission and Link Exchange </h1>
          <h2>&nbsp;</h2>
          <h2><em>Link Submission Tips &amp; Tricks</em>:</h2>
          <h3>Category Selection</h3>
          <p>Please select a category and sub category which best matches to the purpose your website, asthe website addition in the inappropriate category or sub category will probably lead to rejection as well as decrease in future visitors. In case there&rsquo;s two categories or sub categories that will be best fitted to your website, then select that category/sub-category which contains minimum listed websites, or perhaps select that category/sub-category that possess greater page rank.</p>
          <p>&nbsp;</p>
          <h3>Title of your Website: </h3>
          <ol>
            <li>The title of the website has to be brief and relevant to the business of the website.</li>
            <li>It must contain primary keywords in it but don&rsquo;t make a list of keywords in title.</li>
            <li>Be sure that your main keyword must exist in the title.</li>
            <li>Title must not be in caps.</li>
          </ol>
          <p>&nbsp;</p>
          <h3><strong>Description of your Website:</strong> </h3>
          <ol>
            <li>we recommend a short description between 100 – 250 characters.</li>
            <li>Describe the overall theme and internal content of your website.</li>
            <li>Description must include the main keywords in appropriate place and also describe exactly what the website is related to.</li>
            <li>Don&rsquo;t capitalize the first character of all words in the description.</li>
            <li>Don&rsquo;t finish the description by writing &lsquo;etc&rsquo; or &lsquo;…&rsquo;</li>
          </ol>
          <h3>&nbsp;</h3>
          <h3>Adding Unique Email Address</h3>
          <p>Please provide a unique and valid email address by which you can receive notificaitons and other messages from your patner's and admin.</p>
          <p>&nbsp;</p>
          <h2><em>Link Exchange Tips &amp; Tricks:</em></h2>
          <p>&nbsp;</p>
          <p><img src="images/linkexchange-steps.png" alt="Link Exchange Steps" width="458" height="455" /></p>
        </div>
        <!--panelBody ending div--> 
      </div>
      <!--panel ending div--> 
