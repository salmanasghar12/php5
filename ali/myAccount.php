...
<div id="sidebar">
      <div class="panel">
        ...
        <div class="panelBody">
		  ...
		  <?php }?>
            ...
            <a href="MyExchangedLinks.php">
            <li>My Exchanged Links</li>
            </a>
            <a href="ExchangeLink.php">
            <li>Exchange a Link</li>
            </a>
            <a href="RemoveMyLink.php">
             <li>Remove My  Link</li>
            </a>
            <a href="AddFeatured.php">
            <li>Add a Featured link</li>
            </a>
  ...
  <div id="content">
    <div class="panel">
      <div class="panelBody">
        <h1>
          <?php if (isset($_SESSION['MM_Username'])){echo "Wellcome   ".$_SESSION['MM_Username']; }?>
          </h1>
