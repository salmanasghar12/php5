...
if (isset($_SESSION['MM_Username'])){echo "Welcome  ".$_SESSION['MM_Username']."  ".$urlLogout;
  ...
  <div id="main">
    ...
    <div id="content">
      <div class="panel">
        <div class="panelBody">
          <h1>Rules for Link Exchange:</h1>
          <p>The following rules will be applied for the link exchange:</p>
          <ol>
            <li><strong>After link exchange, both partners will embed HTML Code/ Script of each others links by itself. we didn't provide any service for embedding or removing the HTML Code/Script to each other's link.</strong></li>
            <li><strong>After link exchange, it is the responsibility of both partners to regularly check their links on each others links, as we didn't provide any service of checking the existence of your links to each others website/link.</strong></li>
            <li><strong>An Active/ inactive status of a link In <a href="MyExchangedLinks.php">my exchanged links</a> doesn't guaranty wether your link has been embed or removed from your respective partner or not.</strong></li>
            <li><strong>In case of any query from your partner you have to explicitly contact through e-mail with your respective partner.</strong></li>
          </ol>
          <p>&nbsp;</p>
        </div>
        <!--panelBody ending div--> 
