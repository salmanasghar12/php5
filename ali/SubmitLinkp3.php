  ...
  <div id="main">
    ...
    <div id="content" style="height:690px">
      <div class="panel">
        <div class="panelBody">
          <div id="submit">
            <h2>Your Link Submitted Successfully into our  Link Directory. </h2>
          </div>
          
          
          <h3>You can also check your submitted link into by going into our <a href="LinkDirectory.php">Link Directory</a>.</h3>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
