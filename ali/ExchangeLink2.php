...
if (isset($_POST['DropdownListCategory'])) {
	/////////////getting subcategories of user selected categories //////////////////////////
...
<div id="sidebar">
  ...
  <div id="content">
    <div class="panel">
      <div class="panelBody">
      <p><a href="ExchangeLink.php">&lt;- Previous Page</a></p>
      <a href="ExchangeLink3.php<?php echo "?all=1";?>">Show All Links</a>
        <h1>Exchange a Link:</h1>
        <p>Choose your Partner's Link:</p>
        <h3>Your Selected Category: <?php echo $_POST['DropdownListCategory'];?></h3>
        <form name="formSelectSubCategory" id="formSelectSubCategory" method="post" action="ExchangeLink3.php">
        <table width="719">
  <tr>
    <td width="147" height="44" class="linksStyle">Select a Sub-Category:</td>
    <td width="560"><span id="spryselectDropdownListSubCategory">
      <select name="DropdownListSubCategory" id="DropdownListSubCategory">
      <option value="-1">Please Choose One.</option>
        <?php
do {  
?>
        <option value="<?php echo $row_RecordsetSubCategories['id']?>"><?php echo $row_RecordsetSubCategories['Name']?></option>
        <?php
...
?>
      ...
      <span class="selectInvalidMsg">Please choose a valid Sub-Category.</span><span class="selectRequiredMsg">Please choose a valid Sub-Category.</span></span></td>
  </tr>
  <tr>
    <td><h4>Or </h4>
...
var spryselect1 = new Spry.Widget.ValidationSelect("spryselectDropdownListSubCategory", {invalidValue:"-1"});
</script>
</body>
</html>