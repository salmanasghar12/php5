  ...
  <div id="content">
    <div class="panel">
      <div class="panelBody">
        <h1>Admin Tasks:</h1>
        <ul>
          <li><a href="AddRemoveFeaturedLink.php">Add or Remove Featured Link</a></li>
          <li><a href="addCategory.php">Add a New Category</a></li>
          <li><a href="AddSubCategory.php">Add a New Sub-Category</a></li>
          <li><a href="removeLink.admin.php">Remove a Link</a></li>
          <li><a href="removeUser.admin.php">Remove a User</a></li>
          </ul>
        </div>
      <!--panelBody ending div-->
      </div>
