...
<div id="main">
  ...
  <div id="content">
    <div class="panel" >
      <div class="panelBody">
        <h1>User Login</h1>
        <p style="color:#F00">Username or Password Incorrect !</p>
        <div id="LoginDiv" >
          <form id="LoginForm" name="LoginForm" method="POST" action="<?php echo $loginFormAction; ?>">
            <table width="450" height="203" border="0">
              <tr>
                <td width="96" height="46"><h4>Username:</h4></td>
                <td width="338"><span id="sprytextfieldUsername">
              ...
              <tr>
                <td>&nbsp;</td>
                <td><a href="#">Forgot Password?  Click here.</a></td>
              </tr>
            </table>
