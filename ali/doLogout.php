...
<div id="container">
  <div id="header">
    ...
    <div id="navbar">
      ...
      <a href="index.php"><li>Link Directory</li></a>
      <a href="index.php"><li>Submit Link</li></a>
      <a href="index.php"><li>Exchange Link</li></a>
      <a href="index.php"><li>Latest Links</li></a>
  ...
  <div id="main">
    ...
    <div id="content">
      <div class="panel">
        <div class="panelBody">
          <p align="center">You are Being Logged out......</p>
        </div>
        <!--panelBody ending div--> 
      </div>
      <!--panel ending div--> 
