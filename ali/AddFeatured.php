...
if (isset($_SESSION['MM_Username'])){echo "Welcome  ".$_SESSION['MM_Username']."  ".$urlLogout;
  ...
  <div id="main">
    ...
    <div id="content">
      <div class="panel">
        <div class="panelBody">Dear User in order to make your link as Featured Link please send your message to our Site Administrator by going to <a href="ContactUs.php">Contact Us</a> page.</div>
        <!--panelBody ending div--> 
      </div>
      <!--panel ending div--> 
    </div>
