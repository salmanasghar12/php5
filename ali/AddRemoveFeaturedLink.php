  ...
  <div id="content">
    <div class="panel">
      <div class="panelBody">
        ...
        <h1>Add or Remove Featured Link:</h1>
        <p>To Add or Remove a Featured Link Please go To <a href="LinkDirectory.php">Link Directory</a> and Choose your desired Category and Sub-Category.</p>
        </div>
      <!--panelBody ending div-->
      </div>
    <!--panel ending div-->
